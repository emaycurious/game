...
def play():
    # env
    env = gym.make('MountainCarContinuous-v0', autoreset=True, render_mode="human")
    state_dim = env.observation_space.shape[0]
    action_dim = env.action_space.shape[0]

    # mind
    sac = SAC(state_dim, action_dim, 64, 32, 32, 16)
