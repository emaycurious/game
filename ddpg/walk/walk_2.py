...
class DDPG:
    def __init__(self, s_node, a_node):
        self.actor, self.actor_target = Actor(s_node, 50, 25, a_node), Actor(s_node, 50, 25, a_node)
        self.critic, self.critic_target = Critic(s_node, a_node, 25, 25, 12, 1), Critic(s_node, a_node, 25, 25, 12, 1)
...
def play():
    # env
    env = gym.make('Pendulum-v1', autoreset=True, render_mode="human")
