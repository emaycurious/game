...
def play():
    ...
    while 1:
        ...
        old_ball_xy = [ball.x, ball.y]  # t
        ball.step_x = actor.outputs[0][0] * 5
        ball.step_y = actor.outputs[1][0] * 5
        ball.x += ball.step_x  # t+1
        ball.y += ball.step_y
